...
let mainRoutes: Routes = [
    {
        path: '', component: MainView, data: { title: 'Главная' }, children: [
            ...
            { path: 'category/:parentId/:subCategoryId/:lastChildId', loadChildren: () => import('src/app/com/annaniks/uncle-razor/views/main/catalog/catalog.module').then(m => m.CatalogModule), data: { title: 'Каталог товаров' } },
            { path: 'category/:parentId/:subCategoryId', loadChildren: () => import('src/app/com/annaniks/uncle-razor/views/main/catalog/catalog.module').then(m => m.CatalogModule), data: { title: 'Каталог товаров' } },
            { path: 'category/:parentId', loadChildren: () => import('src/app/com/annaniks/uncle-razor/views/main/catalog/catalog.module').then(m => m.CatalogModule), data: { title: 'Каталог товаров' } },
